...
// https://github.com/MariusBongarts/medium-highlighter/blob/master/src/medium-highlighter.ts
...
class MediumHighlighter extends HTMLElement {
  ...
  get styleElement() {
    return (this.shadowRoot as any).querySelector("style");
  }

  get highlightTemplate() {
    return (this.shadowRoot as any).getElementById("highlightTemplate");
  }
  ...
  render() {
    ...
    (this.shadowRoot as any).appendChild(style);
    (this.shadowRoot as any).innerHTML += template;
